...
import com.custodia.supply.models.dto.item.DimensionMapperImpl;
import com.custodia.supply.models.dto.item.DimensionsDTO;
import com.custodia.supply.models.dto.item.PackagingDTO;
import com.custodia.supply.models.dto.item.PackagingMapperImpl;
...
@Service
public class SupplyItemImpl implements ISupplyItemService, IPageableService<SupplyItemViewDTO> {
	...
	@Override
	@Transactional(readOnly = true)
	public Page<SupplyItemViewDTO> findAll(Pageable pageable) {
		return supplyItemDao.findAll(pageable).map(SupplyMapper::toView);  // o supplyView::toDTO según tu mapper real
	}
...
//	}
	...
	//=== Needs to change to chaing responsability!!!
	...
	@Transactional(readOnly = true)
	public Page<SupplyItemViewDTO> findPageByCategory(Long categoryId, Pageable pageable) {
	    return supplyItemDao.findPageByCategoryId(categoryId, pageable).map(SupplyMapper::toView);
	}
