package com.custodia.supply.controllers.request;
...
public class RequestController {
	...
	@Autowired
	private RequestMapperViewImpl requestMapper;
...
//		RequestDTO dto = requestMapper.toDTO(request);//Brings all user with all requests
//=== Testing new version of mapper ==		
		RequestDTO dto = RequestMapper.toTree(request);
